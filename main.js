...
if(board[0][0] === "x" && board[0][1] === "x" && board[0][2] === "x") {
  $('.header').text('Jugador 1 Gana!');
  $('.header').css('color', '#fbff15');
  $('.p1').text ('Jugador 1 : '+ p1Counter);
  p1Counter += 1;
  player1.win = true;
}  
// middle row 
...
if(board[0][0] === "o" && board[0][1] === "o" && board[0][2] === "o") {
  $('.header').text('Jugador 2 Gana!');
  $('.header').css('color', '#33ffda');
  $('.p2').text ('Jugador 2 : ' + p2Counter);
  p2Counter += 1;
  player2.win = true;
}  
// middle row 
